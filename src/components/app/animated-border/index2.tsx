...
export const Example2 = () => {
  return (
    <div className="space-y-8 p-8">
      ...
      {/* </HoverAnimatedBorder> */}
      <RectWrapper className="w-full cursor-pointer" radius={8}>
        <p className="">TEST</p>
      </RectWrapper>
    </div>
  );
...
export const RectWrapper: React.FC<HoverAnimatedBorderProps> = ({ children, radius }) => {
  ...
  return (
    <div
      ...
      className={`relative cursor-text hover:shadow-[0_8px_16px_rgb(0_0_0/0.4)]`}
      onMouseEnter={() => setIsHovered(true)}
      onMouseLeave={() => setIsHovered(false)}
    >
      <svg
