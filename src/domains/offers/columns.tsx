...
export const columns: ColumnDef<JobOffer>[] = [
  ...
  },
  {
    ...
    cell: ({ row }) => <JobOfferEditableCell row={row} fieldName="salary" mapValue={mapNumber} formatter={formatNumber({ style: "currency", currency: "USD" })} validate={validateNumber} />
  },
  {
    ...
    cell: ({ row }) => <JobOfferEditableCell row={row} fieldName="number_of_shares" mapValue={mapNumber} formatter={formatNumber({ useGrouping: true, maximumFractionDigits: 0 })} validate={validateNumber} />
  },
  {
    accessorKey: "latest_company_valuation",
    header: "Latest Company Valuation",
    cell: ({ row }) => <JobOfferEditableCell row={row} fieldName="latest_company_valuation" mapValue={mapNumber} formatter={formatNumber({ "style": "currency", "currency": "USD", maximumFractionDigits: 0 })} validate={validateNumber} />
  },
  {
    accessorKey: "strike_price",
    header: "Strike Price",
    cell: ({ row }) => <JobOfferEditableCell row={row} fieldName="strike_price" mapValue={mapNumber} formatter={formatNumber({ style: "currency", "currency": "USD" })} validate={validateNumber} />
  },
  {
    accessorKey: "vesting_years",
    header: "Vesting Years",
    cell: ({ row }) => <JobOfferEditableCell row={row} fieldName="vesting_years" mapValue={mapNumber} formatter={formatNumber({ useGrouping: true })} validate={validateNumber} />
  },
  {
    accessorKey: "percentage_ownership",
    header: "Percentage Ownership",
    cell: ({ row }) => <JobOfferEditableCell row={row} fieldName="percentage_ownership" mapValue={mapNumber} formatter={formatNumber({ style: "percent", maximumFractionDigits: 4, minimumFractionDigits: 2 })} validate={validateNumber} />
  },
  {
    accessorKey: "total_number_of_outstanding_shares",
    header: "Total Outstanding Shares",
    cell: ({ row }) => <JobOfferEditableCell row={row} fieldName="total_number_of_outstanding_shares" mapValue={mapNumber} formatter={formatNumber({ useGrouping: true })} validate={validateNumber} />
  },
];
