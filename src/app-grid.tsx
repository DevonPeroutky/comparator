...
export function AppGrid() {
  const features: BentoCardProps[] = [
    ...
    },
    {
      ...
      position: "right",
      className:
        "col-span-1 2xl:col-span-3 lg:border-l dark:border-neutral-800",
    },
    {
