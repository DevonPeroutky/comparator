...
export function AppGrid() {
  const features: BentoCardProps[] = [
    ...
    },
    {
      ...
      content: <GlobeCard />,
      className: "border-b col-span-1 md:col-span-2 dark:border-neutral-800 xl:pr-32 2xl:pr-44",
    },
    {
      ...
      className: "col-span-1 md:col-span-3 xl:col-span-3 border-b lg:border-none xl:pl-32 2xl:pl-44",
    },
    {
      ...
      content: <OffersGraph />,
      className:
        "col-span-1 md:col-span-2 2xl:col-span-3 lg:border-l dark:border-neutral-800 xl:pl-32 2xl:pr-44",
    },
    {
